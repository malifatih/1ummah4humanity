    ...
    <aside className="sidebar">
      ...
      <style jsx>{`
        ...
        .brand-container {
            ...
            margin-left: 0.5rem; /* Align visual center with nav icons roughly */
        }

        .brand-container:hover {
            background: rgba(var(--hue-brand), 100%, 60%, 0.1);
        }

        .brand-icon {
            object-fit: contain;
            width: 32px; /* Slightly smaller to fit in 50px circle comfortably */
            height: 32px;
        }

        /* Removed brand-logo text styles */
